...
const GetAllMobile = () => {
    ...
    return (
        <div className="gm-wrapper">
            ...
            <div className="gm-topbar">
                <Link to="/admin" className="gm-nav-pill">⬅ Back</Link>
                <span className="gm-nav-pill gm-admin-pill">🛠 Admin View</span>
            </div>

            <div className="gm-header">
                <h1 className="gm-title">Available Mobile Phones</h1>
                <p className="gm-subtitle">Manage and review all listed devices</p>
            </div>
    ...
    <div className="gm-card-body">
        ...
        <Link to={"/admin/getallmobile/" + item.phoneID} className="gm-buy-btn">
            Mobile Detail
        </Link>
    </div>
</div>
